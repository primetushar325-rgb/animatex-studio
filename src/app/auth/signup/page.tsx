...
function SignupForm() {
  ...
  const { signUp, signInWithGoogle, loading, error, clearError, user, initialize, initialized } = useAuthStore();
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800/50 backdrop-blur-lg border border-slate-700 rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">Start creating amazing animations</p>
          </div>
          ...
          <p className="mt-6 text-center text-slate-400">
            ...
            <Link
              href={`/auth/login${redirect !== '/studio' ? `?redirect=${redirect}` : ''}${action ? `&action=${action}` : ''}`}
